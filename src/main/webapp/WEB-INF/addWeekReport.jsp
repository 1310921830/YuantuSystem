	...
	$(function() {
		...
		$("#btn").click(function() {
			...
			if (result==0){
				...
				alert("附件不能为空");
			}else if ($(".easyui-numberbox").val().length == 0) {
				alert("不能为空");
			}else {
    ...
    <FORM id="form">
		...
		<TABLE CELLSPACING="0" CELLPADDING="0" CLASS="TableStyle" STYLE="width: 90%">
			...
			<TBODY>
				...
				<TR ALIGN=center VALIGN=middle ID=TableTitle>
					...
					<TD STYLE="border-bottom: 1px solid #94C6E7;" width="25%">制作人</TD>
					<TD STYLE="border-bottom: 1px solid #94C6E7;" width="25%">
						<c:out value="${user.name}"></c:out>
					</TD>
					
					<TD STYLE="border-bottom: 1px solid #94C6E7;" width="25%">项目完成进度(%)</TD>
					<TD STYLE="border-bottom: 1px solid #94C6E7;" width="25%">
						<input name="process" class="easyui-numberbox" data-options="min:0,max:100" style="width:50%;">
					</TD>
				</TR>
		...
		<TABLE CELLSPACING="0" CELLPADDING="0" CLASS="TableStyle" STYLE="width: 90%">
			...
			<TBODY>
				...
				<textarea name="staffChange" rows="2" class="i1"></textarea> 
				</td>
				</tr>
			</TBODY>
		...
		<TABLE CELLSPACING="0" CELLPADDING="0" CLASS="TableStyle" STYLE="width: 90%">
			...
			<td colspan="6" align="left" STYLE="border-bottom: 1px solid #94C6E7;">
				<textarea name="completion" rows="6" class="i1"></textarea> 
				</td>
			</tr>
			<tr ALIGN=center VALIGN=middle ID=TableTitle>
			<TD colspan="6" align="left">&nbsp;&nbsp;2.2 本周应完成而未完成的任务（工作任务，责任人，未完成的原因，何时完成）</TD>
				...
				<tr ALIGN=center VALIGN=middle ID=TableTitle>
				<td colspan="6" align="left" STYLE="border-bottom: 1px solid #94C6E7;">
				<textarea name="uncompletion" rows="6" class="i1"></textarea> 
				</td>
				</tr>
            <tr ALIGN=center VALIGN=middle ID=TableTitle>
			<TD colspan="6" align="left">&nbsp;&nbsp;2.3 本周任务变动情况（增加或减少的任务，增减原因）</TD>
				...
				<tr ALIGN=center VALIGN=middle ID=TableTitle>
				<td colspan="6" align="left" STYLE="border-bottom: 1px solid #94C6E7;">
				<textarea name="taskChange" rows="6" class="i1"></textarea> 
				</td>
				</tr>
				<tr ALIGN=center VALIGN=middle ID=TableTitle>
		...
		<TABLE CELLSPACING="0" CELLPADDING="0" CLASS="TableStyle" STYLE="width: 90%">
			...
			<TBODY>
				<tr ALIGN=center VALIGN=middle ID=TableTitle>
				<td colspan="6" rowspan="10" align="left" STYLE="border-bottom: 1px solid #94C6E7;">
				<textarea name="others" rows="6" class="i1"></textarea> 
				</td>
				</tr>
			</TBODY>
