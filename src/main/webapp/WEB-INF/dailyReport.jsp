    ...
    <FORM id="form">
			...
			<TBODY>
				<TR ALIGN=center VALIGN=middle ID=TableTitle>
					...
					<TD STYLE="border-bottom: 1px solid #94C6E7;">
						<c:out value="${dailyReport.title}"></c:out>
					</TD>
					<TD STYLE="border-bottom: 1px solid #94C6E7;">报告日期</TD>
					<TD STYLE="border-bottom: 1px solid #94C6E7;">
						<c:out value="${dailyReport.date }"></c:out>
					</TD>
		...
		<TABLE CELLSPACING="0" CELLPADDING="0" CLASS="TableStyle" STYLE="width: 90%">
			...
			<TBODY>
				...
				<textarea name="task" rows="6" readonly="readonly"><c:out value="${dailyReport.task}"></c:out>
				</textarea> 
				</td>
				</tr>
			</TBODY>
		...
		<TABLE CELLSPACING="0" CELLPADDING="0" CLASS="TableStyle" STYLE="width: 90%">
			...
			<TBODY>
				<tr ALIGN=center VALIGN=middle ID=TableTitle>
				<td colspan="6" rowspan="10" align="left" STYLE="border-bottom: 1px solid #94C6E7;">
				<textarea name="goal" rows="6" readonly="readonly"><c:out value="${dailyReport.goal }"></c:out>
				</textarea> 
				</td>
				</tr>
			</TBODY>
		...
		<TABLE CELLSPACING="0" CELLPADDING="0" CLASS="TableStyle" STYLE="width: 90%">
			...
			<TBODY>
				<tr ALIGN=center VALIGN=middle ID=TableTitle>
				<td colspan="6" rowspan="10" align="left" STYLE="border-bottom: 1px solid #94C6E7;">
				<textarea name="summary" rows="6" readonly="readonly"><c:out value="${dailyReport.summary }"></c:out>
				</textarea> 
				</td>
				</tr>
			</TBODY>
		...
		<TABLE CELLSPACING="0" CELLPADDING="0" CLASS="TableStyle" STYLE="width: 90%">
			...
			<TBODY>
				<tr ALIGN=center VALIGN=middle ID=TableTitle>
				<td colspan="6" rowspan="10" align="left" STYLE="border-bottom: 1px solid #94C6E7;">
				<textarea name="problem" rows="6" readonly="readonly"><c:out value="${dailyReport.problem }"></c:out>
				</textarea> 
				</td>
				</tr>
			</TBODY>
		...
		<TABLE CELLSPACING="0" CELLPADDING="0" CLASS="TableStyle" STYLE="width: 90%">
			...
			<TBODY>
				<tr ALIGN=center VALIGN=middle ID=TableTitle>
				<td colspan="6" rowspan="10" align="left" STYLE="border-bottom: 1px solid #94C6E7;">
				<textarea name="nextPlan" rows="6" readonly="readonly"><c:out value="${dailyReport.nextPlan }"></c:out>
				</textarea> 
				</td>
				</tr>
			</TBODY>
		...
		<c:if test="${dailyReport.preparedName eq user.userId}">
				...
				STYLE="width: 90%">
					...
					<tr ALIGN=center VALIGN=middle ID=TableTitle>
						<td colspan="6" rowspan="10" align="left" STYLE="border-bottom: 1px solid #94C6E7;">
						<textarea name="opinion" rows="6" class="i1" readonly="readonly"><c:out value="${dailyReport.opinion}"></c:out>
						</textarea> 
						</td>
					</tr>
					</TABLE>
				</c:if>
				<c:if test="${dailyReport.reviewedName eq user.userId}">
					<c:if test="${'是' eq dailyReport.isCheck }">
						<TABLE CELLSPACING="0" CELLPADDING="0" CLASS="TableStyle"
				STYLE="width: 90%">
						<TR ALIGN=center VALIGN=middle ID=TableTitle>
					...
					<c:if test="${'否' eq dailyReport.isCheck }">
					<TABLE CELLSPACING="0" CELLPADDING="0" CLASS="TableStyle"
				STYLE="width: 90%">	
					<TR ALIGN=center VALIGN=middle ID=TableTitle>
						<TD colspan="6" align="left">&nbsp;&nbsp;四、批注意见</TD>
...
<DIV ID="InputDetailBar">
		<a href="download?path=${dailyReport.link}" id="afile">附件下载</a>
	</DIV>
